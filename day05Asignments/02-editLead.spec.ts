...
test(`Test to edit a lead`, async ({page}) => {
    ...
    //Enter firstName
    await page.locator("(//div[@class='x-form-element']/input[@name='firstName'])[3]").fill("Akshata");
    ...
    //click on first lead
    await page.locator("//div[@class='x-grid3-cell-inner x-grid3-col-partyId']/a").click();
